...
@WebServlet(name="GetHerbal", urlPatterns={"/GetHerbal"})
public class GetHerbal extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       // String pass=request.getParameter("password");
        ...
        ArrayList<String> herbal=new ArrayList<String>();
                ...
                if(connection)
                {
                     try{
                          statement=conn.createStatement();
                           String sql = "select name,code from herbal ORDER BY id";
