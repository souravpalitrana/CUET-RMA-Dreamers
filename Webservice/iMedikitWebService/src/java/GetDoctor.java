...
public class GetDoctor extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      //String specCode="dis001_spec001";
     ...
     /*   try {
                ...
                if(connection)
                {
                     try{
                          statement=conn.createStatement();
                           String sql = "select id, name from doctor_info WHERE spec_code LIKE '"+specCode+"' ORDER BY id";
        ...
        name.add(rs.getString("name"));
          doctor_code.add(rs.getString("id"));
         ...
         //Display values
                    ...
                    json.put("success", 1);
                    json.put("name", name);
                     json.put("doctor_code", doctor_code);
