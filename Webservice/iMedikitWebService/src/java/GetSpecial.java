...
@WebServlet(name="GetSpecial", urlPatterns={"/GetSpecial"})
public class GetSpecial extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String disCode=request.getParameter("district_code");
      //String disCode="dis001";
     ...
     /*   try {
                ...
                if(connection)
                {
                     try{
                          statement=conn.createStatement();
                           String sql = "select name, spec_code from special WHERE district_code LIKE '"+disCode+"' ORDER BY id";
        ...
        name.add(rs.getString("name"));
          spec_code.add(rs.getString("spec_code"));
