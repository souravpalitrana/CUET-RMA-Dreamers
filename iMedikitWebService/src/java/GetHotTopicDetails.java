...
@WebServlet(name="GetHotTopicDetails", urlPatterns={"/GetHotTopicDetails"})
public class GetHotTopicDetails extends HttpServlet {
                ...
                if(connection)
                {
                     try{
                          statement=conn.createStatement();
                           String sql = "select  description from hot_topic WHERE id = "+code+" ORDER BY id";
