...
list.setOnItemClickListener(new OnItemClickListener() {
  ...
  runner.execute();
	...
	//--------------------------------------------------------------
			...
			{
				 ProgressDialog progressDialog = new ProgressDialog(DoctorList.this);
				 private static final String TAG = "PostFetcher";
					public String SERVER_URL = "http://192.168.43.27:8080/iMedikitWebService/GetDoctorDetails";
				...
				protected String doInBackground(String... params) {
					...
					try
					{
						...
						pair.add(new BasicNameValuePair("doctor_code", selected));
				...
				protected void onPostExecute(String string)
				{
					...
					//view.setText(data.toString()+" "+phonetic.toString());
						...
						Intent intent=new Intent(DoctorList.this,DoctorDetails.class);
