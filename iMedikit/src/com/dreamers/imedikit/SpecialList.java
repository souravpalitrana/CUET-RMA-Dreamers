...
import com.dreamers.gsonlibrary.Doctor;
...
list.setOnItemClickListener(new OnItemClickListener() {
  ...
  AsyncTaskRunnerDoctor runner =new  AsyncTaskRunnerDoctor();
  runner.execute();
	...
	//--------------------------------------------------------------
			...
			class AsyncTaskRunnerDoctor extends AsyncTask<String, String, String>
			{
				 ProgressDialog progressDialog = new ProgressDialog(SpecialList.this);
				 private static final String TAG = "PostFetcher";
					public  String SERVER_URL = "http://192.168.43.27:8080/iMedikitWebService/GetDoctor";
				...
				protected String doInBackground(String... params) {
					...
					try
					{
						...
						pair.add(new BasicNameValuePair("spec_code", selected));
						...
						if(statusLine.getStatusCode() == 200) {
							...
							InputStream content = entity.getContent();
								...
								Gson gson = new Gson();
								List<Doctor> posts = Arrays.asList(gson.fromJson(reader, Doctor.class));
								content.close();
								...
								for(Doctor res : posts) {
								
									 spec_name=(ArrayList<String>) res.name;
									spec_code=(ArrayList<String>)res.doctor_code;
				...
				protected void onPostExecute(String string)
				{
					...
					//view.setText(data.toString()+" "+phonetic.toString());
						...
						Intent intent=new Intent(SpecialList.this,DoctorList.class);
