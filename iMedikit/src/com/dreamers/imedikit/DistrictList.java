...
public class DistrictList extends Activity {
	ListView list;
	LinearLayout search;
...
//  Toast.makeText(getApplicationContext(), selected+" "+name.get(position), Toast.LENGTH_LONG).show();			
  ...
  runner.execute();
	...
	//--------------------------------------------------------------
			...
			{
				 ProgressDialog progressDialog = new ProgressDialog(DistrictList.this);
				 private static final String TAG = "PostFetcher";
					public  String SERVER_URL = "http://192.168.43.27:8080/iMedikitWebService/GetSpecial";
				...
				protected String doInBackground(String... params) {
					...
					try
					{
						...
						pair.add(new BasicNameValuePair("district_code", selected));
						...
						if(statusLine.getStatusCode() == 200) {
							...
							InputStream content = entity.getContent();
								...
								Gson gson = new Gson();
								List<Special> posts = Arrays.asList(gson.fromJson(reader, Special.class));
								content.close();
								...
								for(Special res : posts) {
								
									 spec_name=(ArrayList<String>) res.name;
									spec_code=(ArrayList<String>)res.spec_code;
				...
				protected void onPostExecute(String string)
				{
					...
					//view.setText(data.toString()+" "+phonetic.toString());
						...
						Intent intent=new Intent(DistrictList.this,SpecialList.class);
						intent.putExtra("name", spec_name);
						intent.putExtra("code", spec_code);
						startActivity(intent);
					//	finish();
						overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
						//Toast.makeText(getApplicationContext(), spec_name+" "+selected, Toast.LENGTH_LONG).show();
