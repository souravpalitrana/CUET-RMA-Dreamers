...
list.setOnItemClickListener(new OnItemClickListener() {
  ...
  runner.execute();
	...
	//--------------------------------------------------------------
			...
			{
				 ProgressDialog progressDialog = new ProgressDialog(HerbalList.this);
				 private static final String TAG = "PostFetcher";
					public  String SERVER_URL = "http://192.168.43.27:8080/iMedikitWebService/GetHerbalDetails";
                     ...
                     List<NameValuePair> pair= new ArrayList<NameValuePair>();
						...
						if(statusLine.getStatusCode() == 200) {
							...
							InputStream content = entity.getContent();
								...
								Gson gson = new Gson();
								List<HerbalDetails> posts = Arrays.asList(gson.fromJson(reader,HerbalDetails.class));
								content.close();
								...
								for(HerbalDetails res : posts) {
								
									 spec_name=(ArrayList<String>) res.remedy;
									spec_code=(ArrayList<String>)res.description;
				...
				protected void onPostExecute(String string)
				{
					...
					//view.setText(data.toString()+" "+phonetic.toString());
						...
						Intent intent=new Intent(HerbalList.this,HerbalDetailsActivity.class);
